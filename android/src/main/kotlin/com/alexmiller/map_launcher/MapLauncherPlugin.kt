...
private enum class MapType { google, googleGo, amap, baidu, waze, yandexNavi, yandexMaps, citymapper, mapswithme, osmand, osmandplus, doubleGis, tencent, here, petal, tomtomgo, sygicCar, sygicTruck }
...
class MapLauncherPlugin : FlutterPlugin, MethodCallHandler {
    ...
    private val maps = listOf(
            ...
            MapModel(MapType.sygicCar, "Sygic (car)", "com.sygic.aura"),
